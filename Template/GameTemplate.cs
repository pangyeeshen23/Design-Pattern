...
namespace DesignPattern.Template
{
    ...
    // Functional Template Design Pattern
    public static class GameTemplate
    {
        ...
        public static void Run()
        {
            int numbeOfPlayers = 2;
            int currentPlayer = 0;
            int turn = 1, maxTurns = 10;

            void Start()
            {
                WriteLine($"Starting a game of chess with {numbeOfPlayers} players");
            }
            ...
            void TakeTurn()
            {
                ...
                currentPlayer = (currentPlayer + 1) % numbeOfPlayers;
            }
