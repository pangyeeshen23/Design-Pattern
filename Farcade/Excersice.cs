...
namespace DesignPattern.Farcade
{
    class Excersice
    {
        ...
        /// this is a farcade pattern, where we have a simple interface to generate a magic square
        /// from combining the Generator, Splitter, and Verifier classes.
        public class MagicSquareGenerator
        {
            public List<List<int>> Generate(int size)
            {
                ...
                bool isValidMagicSquare = false;
                while (isValidMagicSquare == false)
                {
                    ...
                    List<List<int>> lines = splitter.Split(magicSquare);
                    Verifier verifier = new Verifier();
                    if (verifier.Verify(lines)) isValidMagicSquare = true;
                }
                 return magicSquare;
            }
        }
